...
config.recording_path = "/usr/local/freeswitch/storage/recording"
config.upload_path = "/usr/local/freeswitch/storage/upload"
config.upload_path = "/Users/apple/tmp/upload"
-- config.block_path = "/usr/local/freeswitch/scripts"
