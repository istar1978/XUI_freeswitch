	...
	XML_STRING = [[<domain name="]] .. domain .. [[">
		<user id="]] .. user .. [[">
			<params>
				...
				<param name="jsonrpc-allowed-fsapi" value="console_complete,log,version,help,bgapi,conference,unload,reload,load,bgapi,uuid_phone_event,status,show,fsapi,jsapi,sofia,list_users,callcenter_config,jsjson,conference"/>
